...
from .models import Water,Water_Kinds,Water_Facts
...
class AddAnimalForm(forms.ModelForm):
    ...
    class_of_animal = forms.ModelChoiceField(queryset=Water_Kinds.objects.all(),empty_label="Выбрать класс",
                                             label="Класс животного")
    unique_fact = forms.ModelChoiceField(queryset=Water_Facts.objects.all(), empty_label="Выбрать факт",
